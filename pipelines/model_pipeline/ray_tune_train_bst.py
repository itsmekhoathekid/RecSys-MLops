...
from pipelines.model_pipeline.model_registry import register_model_config
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", default="/workspace/recsys/data_pipeline/output/ml/ray")
