...
def build_rayjob(args: argparse.Namespace) -> dict[str, Any]:
    ray_args = [
        "python",
        "-m",
        "pipelines.model_pipeline.ray_tune_train_bst",
        "--base-config-path",
...
def main() -> int:
    ...
    parser.add_argument("--base-config-path", default="/opt/recsys/config/bst.yaml")
    parser.add_argument("--split-dir", default="/workspace/recsys/notebooks/data/bst_split")
    parser.add_argument("--ray-output-dir", default="/workspace/recsys/data_pipeline/output/ml/ray")
    parser.add_argument("--best-result-path", default="/workspace/recsys/data_pipeline/output/ml/ray/best_result.json")
