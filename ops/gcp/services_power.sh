...
DEFAULT_CPU_NODES="${GCP_CPU_NODES:-2}"
DEFAULT_CPU_MIN_NODES="${GCP_CPU_MIN_NODES:-${DEFAULT_CPU_NODES}}"
DEFAULT_CPU_MAX_NODES="${GCP_CPU_MAX_NODES:-2}"
...
DEFAULT_LLM_CPU_NODES="${GCP_LLM_CPU_NODES:-0}"
DEFAULT_LLM_CPU_MIN_NODES="${GCP_LLM_CPU_MIN_NODES:-${DEFAULT_LLM_CPU_NODES}}"
DEFAULT_LLM_CPU_MAX_NODES="${GCP_LLM_CPU_MAX_NODES:-0}"
