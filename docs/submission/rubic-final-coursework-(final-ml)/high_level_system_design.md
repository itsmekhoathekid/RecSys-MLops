...
| Helm, Terraform, and Kubernetes | [`gke.tf`](../../../infra/terraform/gcp/modules/gke/main.tf), [`recsys_services.tf`](../../../infra/terraform/gcp/modules/kubernetes-platform/recsys_services.tf), and [`infra/helm/`](../../../infra/helm/) |
...
| Unit, contract, integration, E2E, and load verification | [Inference validation suite](../../../tests/unit/api_serving/inference_api/test_validation_design.py), [Online Feature validation suite](../../../tests/unit/api_serving/online_feature_api/test_validation_design.py), [Locust serving workload](../../../tests/load/locustfile_serving.py) |
