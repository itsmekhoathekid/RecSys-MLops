...
- [iceberg.py (line 8)](../../../apps/data-platform/src/lakehouse/iceberg.py#L8), [iceberg.py (line 118)](../../../apps/data-platform/src/lakehouse/iceberg.py#L118): Iceberg catalog configuration for lakehouse and feature-store warehouses.
...
- [optimize.py (line 34)](../../../apps/data-platform/src/lakehouse/optimize.py#L34), [optimize.py (line 115)](../../../apps/data-platform/src/lakehouse/optimize.py#L115): runnable maintenance job for curated Iceberg tables.
- [rubric_data_pipeline_dags.py (line 288)](../../../apps/data-platform/src/orchestration/airflow/dags/rubric_data_pipeline_dags.py#L288), [rubric_data_pipeline_dags.py (line 271)](../../../apps/data-platform/src/orchestration/airflow/dags/rubric_data_pipeline_dags.py#L271): manual/cron `recsys_lakehouse_maintenance` DAG.
...
- Code reference:
  ...
  - [optimize.py (line 102)](../../../apps/data-platform/src/lakehouse/optimize.py#L102): aggregates the before-file count.
  - [optimize.py (line 103)](../../../apps/data-platform/src/lakehouse/optimize.py#L103): aggregates the after-file count.
  - [optimize.py (line 112)](../../../apps/data-platform/src/lakehouse/optimize.py#L112): reports the file-count reduction.
...
- Code reference:
  - [optimize.py (line 34)](../../../apps/data-platform/src/lakehouse/optimize.py#L34): selects tables by `silver`, `features`, or `all` scope.
  - [optimize.py (line 39)](../../../apps/data-platform/src/lakehouse/optimize.py#L39): adds Silver tables.
  - [optimize.py (line 41)](../../../apps/data-platform/src/lakehouse/optimize.py#L41): adds feature tables.
  - [optimize.py (line 85)](../../../apps/data-platform/src/lakehouse/optimize.py#L85): iterates over the selected tables.
  - [optimize.py (line 88)](../../../apps/data-platform/src/lakehouse/optimize.py#L88): invokes compaction for each table.
  - [rubric_data_pipeline_dags.py (line 202)](../../../apps/data-platform/src/orchestration/airflow/dags/rubric_data_pipeline_dags.py#L202): constructs the Spark maintenance command.
  - [rubric_data_pipeline_dags.py (line 204)](../../../apps/data-platform/src/orchestration/airflow/dags/rubric_data_pipeline_dags.py#L204): points the command to `lakehouse/optimize.py`.
  - [rubric_data_pipeline_dags.py (line 288)](../../../apps/data-platform/src/orchestration/airflow/dags/rubric_data_pipeline_dags.py#L288): defines the maintenance DAG.
...
- Code reference:
  ...
  - [iceberg.py (line 98)](../../../apps/data-platform/src/lakehouse/iceberg.py#L98): registers the lakehouse catalog with Spark.
  - [iceberg.py (line 99)](../../../apps/data-platform/src/lakehouse/iceberg.py#L99): registers the feature catalog with Spark.
