...
| Data storage optimization | [data_storage.md](data_storage.md) | Lakehouse compaction/partitioning and Postgres secondary indexes. |
| Data pipeline orchestration | [data_pipeline_orchestration.md](data_pipeline_orchestration.md) | Airflow DP1/DP2/DP3 stage order and task logs. |
