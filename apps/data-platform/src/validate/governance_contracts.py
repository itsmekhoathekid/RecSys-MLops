...
from metadata.governance_catalog import BRONZE_URNS, POSTGRES_FEATURE_URNS
...
def validate_dp1_bronze(*, root: str | None = None) -> dict[str, Any]:
    ...
    return write_report("DP1", datasets, root=root)
