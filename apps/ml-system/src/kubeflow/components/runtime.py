...
DEFAULT_RUNTIME_SECRET_NAME = os.getenv(
    "RECSYS_KFP_RUNTIME_SECRET_NAME", "recsys-mlops-runtime"
)
DEFAULT_NODE_SELECTOR = os.getenv(
    "RECSYS_KFP_NODE_SELECTOR", "recsys.ai/pool=ml-system"
)
