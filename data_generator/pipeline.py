        ...
        dq_report = {
            ...
            "injected": {
                ...
                "conflicting_duplicates": (
                    challenge_stats.conflicting_duplicates_injected
                ),
                "late_arrivals": challenge_stats.late_arrivals_injected,
                "out_of_order": challenge_stats.out_of_order_injected,
            },
            "observed": {
                **duplicate_stats,
                "late_arrival_rate": round(
                    challenge_stats.late_arrivals_injected
                    / max(challenge_stats.clean_event_count, 1),
                    6,
                ),
                "out_of_order_rate": round(
                    challenge_stats.out_of_order_injected
                    / max(challenge_stats.clean_event_count, 1),
                    6,
                ),
