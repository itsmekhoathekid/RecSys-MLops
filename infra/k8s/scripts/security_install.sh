...
seed_vault_secrets() {
  ...
  vault_exec "vault kv put '${VAULT_KV_MOUNT}/data-platform' DATA_PLATFORM_MINIO_ROOT_USER=minio DATA_PLATFORM_MINIO_ROOT_PASSWORD=minio123 MINIO_ROOT_USER=minio MINIO_ROOT_PASSWORD=minio123 AWS_ACCESS_KEY_ID=minio AWS_SECRET_ACCESS_KEY=minio123 POSTGRES_USER=recsys POSTGRES_PASSWORD=recsys AIRFLOW_POSTGRES_USER=airflow AIRFLOW_POSTGRES_PASSWORD=airflow FEAST_POSTGRES_USER=feast FEAST_POSTGRES_PASSWORD=feast"
