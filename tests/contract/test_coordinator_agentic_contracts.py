...
def test_coordinator_shell_entrypoints_are_syntactically_valid() -> None:
    for relative_path in (
        ...
        "jenkins/scripts/deploy/agentic/registry_publish.sh",
        "jenkins/scripts/deploy/agentic/registry_transport.sh",
        "jenkins/scripts/deploy/agentic/registry_verify.sh",
